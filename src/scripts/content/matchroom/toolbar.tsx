  ...
  components.toolbar = createComponent('toolbar').render(
    <ReactShadowRoot.Div>
      ...
      <Toolbar>
        ...
        <ToolbarBody>
          <Range title="Match" type={SuntzuRange.MatchRange} />
          <Range title="Time" type={SuntzuRange.TimeRange} />
          <Range title="Player" type={SuntzuRange.PlayerRange} />
        </ToolbarBody>
      </Toolbar>
    </ReactShadowRoot.Div>
  );
  // attach component to the matchroom information
  components.toolbar.prependTo(info);
}, 250);
